...
*/
function makeSmartPerson(userName, num1, num2) {
  const person1 = {
    name: userName,
    sum: (num1, num2) => num1 + num2,
    speak: () => `Hello, my name is ${person1.name}`
  };
...
function getCarInfoById(array,Index) {
  return `This is a ${array[Index-1].car_make} ${array[Index-1].car_model}`;
}
